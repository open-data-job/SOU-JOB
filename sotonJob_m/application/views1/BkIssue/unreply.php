				...
				<div class="info-center">
					...
					<div class="info-center-con">
						<div class=" info-center-title h5 margin-big-top clearfix">
							<span class="fl padding-large-right manage-title"><a href="<?php echo base_url('admin/bkmain/index/')?>">All Message</a></span>
							<span class="fl padding-large-right manage-title"><a href="<?php echo base_url('admin/bkmain/unreply_issue/')?>">Unchecked Message(<?php echo $nums ?>)</a></span>
						</div>
						<p style="width: 100px; left: 100px;" class="solid-slider">
						</p>
					</div>
